...
import { downloadChapterPdf, ChapterPdfOptions } from '../utils/chapterPdfGenerator';
  ...
  return (
    ...
    >
      <div className="bg-[#FDFCF8] text-[#2C2C2C] w-full max-w-xl rounded-2xl border border-[#E5E2D9] shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        {/* Footer Actions */}
        <div className="p-4 border-t border-[#E5E2D9] bg-[#F7F5EE]/80 flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
          ...
          <button
            ...
            disabled={isGenerating}
            className="px-6 py-2.5 rounded-xl bg-[#4A5D4E] hover:bg-[#3C4C3F] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer disabled:opacity-50"
          >
            {isGenerating ? (
              <>
